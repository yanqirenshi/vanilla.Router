riot.tag2('app', '<div ref="page-area"></div>', '', '', function(opts) {
     this.site = () => {
...
riot.tag2('section-header', '<section class="section"> <div class="container"> <h1 class="title is-{opts.no ? opts.no : 3}"> {opts.title} </h1> <h2 class="subtitle">{opts.subtitle}</h2> <yield></yield> </div> </section>', 'section-header > .section { background: #f8f4ea; }', '', function(opts) {
});
...
riot.tag2('home_tab_readme', '<section class="section"> <div class="container"> <h1 class="title">CDN</h1> <h2 class="subtitle"></h2> </div> </section>', '', '', function(opts) {
});

riot.tag2('home_tab_usage', '<section class="section"> <div class="container"> <h1 class="title">HTML</h1> <h2 class="subtitle"></h2> </div> </section> <section class="section"> <div class="container"> <h1 class="title">ノードの取得</h1> <h2 class="subtitle"></h2> <div class="contents"> <p> <code>new VanillaRouter().getNode(\'...\')</code> </p> </div> </div> </section>', '', '', function(opts) {
});
